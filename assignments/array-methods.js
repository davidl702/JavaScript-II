...
runners.forEach((index) => {
    return fullName.push(`${index.first_name} ${index.last_name}`)
})
...
let allCaps = [];
runners.map((index) => {
    return allCaps.push(index.first_name.toUpperCase())
})
console.log(allCaps); 
...
const donations = runners.map(runner => {
...
let allCaps = [];
runners.map((index) => {
    return allCaps.push(index.email.toUpperCase())
})
console.log(allCaps)
...
let emails = [];
runners.forEach((index) => {
    return emails.push(`${index.email}`)
})
console.log(emails)
...
runners.forEach(runner => {
   return company.push(`${runner.company_name}`)
})
console.log(company)